...
/* Be-mani 980107 begin */
extern _IMPEXP_ROOT int	creat(const char *path, mode_t mode);
extern _IMPEXP_ROOT int	open(const char *pathname, int oflags, ...);
extern _IMPEXP_ROOT int	fcntl(int fd, int op, ...);
/* Be-mani 980107 end */
...
/* Change record
   ...
   Be-mani	980107	Add Be shared lib changes
