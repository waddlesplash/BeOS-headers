...
//
    ...
    explicit
    valarray (size_t n) 
    : _len (n), _ptr (_len ? new double[_len] : 0) {
        fill_n (_ptr, _len, double());
    }

    valarray (const double& t, size_t n)
    : _len (n), _ptr (_len ? new double[_len] : 0) 
    { 
        fill_n (_ptr, _len, t);
    }
    ...
    : _len (v.length ()), _ptr (_len ? new double[_len] : 0) 
    {
#ifdef MSIPL_USING_NAMESPACE
    ...
    valarray (const mask_array<double>& m)
    : _len (m._len), _ptr (_len ? new double[_len] : 0) 
    {
        __msipl_copy_iter (m._ptr_ptr, m._ptr_ptr+_len, _ptr);
    }

    valarray (const slice_array<double>& s)
    : _len (s._len), _ptr (_len ? new double[_len] : 0) 
    {
        __msipl_copy_iter (s._ptr_ptr, s._ptr_ptr+_len, _ptr);
    }

    valarray (const gslice_array<double>& g)
    : _len (g._len), _ptr (_len ? new double[_len] : 0)
    {
        __msipl_copy_iter (g._ptr_ptr, g._ptr_ptr+_len, _ptr);
    }

    valarray (const indirect_array<double>& i)
    : _len (i._len), _ptr (_len ? new double[_len] : 0)
    {
...
//
    ...
    //operator double* () { READ_LOCK(va_mutex); return _ptr; }  //not?

    operator const double* () const { READ_LOCK(va_mutex); return _ptr; }
...
//
    ...
    {
        READ_LOCK(va_mutex);
        slice_array<double>      sarray (*this, s);
        return valarray<double> (sarray);
    }

    valarray   operator[] (const gslice& g) const
    {
        READ_LOCK(va_mutex);
        gslice_array<double>     garray (*this,g);
        return valarray<double> (garray);
    }

    valarray   operator[] (const valarray<bool>& vb) const
    {
        READ_LOCK(va_mutex);
        mask_array<double>       marray (*this, vb);
        return valarray<double> (marray);
    }

    valarray   operator[] (const valarray<size_t>&  vi) const
    {
        READ_LOCK(va_mutex);
        indirect_array<double>   iarray (*this, vi);
        return valarray<double> (iarray);
    }

    slice_array<double>     operator[] (slice  s)
    {
        READ_LOCK(va_mutex);
        return slice_array<double> (*this, s);
    }

    gslice_array<double>    operator[] (const gslice& g)
    {
        READ_LOCK(va_mutex);
        return gslice_array<double> (*this, g);
    }

    mask_array<double>      operator[] (const valarray<bool>&  vb)
    {
        READ_LOCK(va_mutex);
        return mask_array<double> (*this, vb);
    }

    indirect_array<double>  operator[] (const valarray<size_t>&  vi)
    {
        READ_LOCK(va_mutex);
        return indirect_array<double> (*this, vi);
    } 
...
//
    ...
    valarray<double>& operator= (const valarray<double>&); //want more than double? bkoz
    valarray<double>& operator= (const double&);
    valarray<double>& operator= (const mask_array<double>&);
    valarray<double>& operator= (const slice_array<double>&);
    valarray<double>& operator= (const gslice_array<double>&);
    valarray<double>& operator= (const indirect_array<double>&);
...
//
    ...
    valarray operator- () const 
    {
       ...
       return valarray<double> (*this, negate<double> ());
#else
       return val_array (*this, negate<double> ());
#endif
    }
    ...
    valarray operator! () const
    {
       READ_LOCK(va_mutex);
#ifdef MSIPL_MEMBER_TEMPLATE
       return valarray<double> (*this, __msipl_not<double> ());
#else
       return val_array (*this, __msipl_not<double> ());
#endif
    }
	#else
		valarray operator! () const;
...
//
    ...
    valarray& operator*= (const double& t)
    {
        WRITE_LOCK(va_mutex);
        __msipl_copy_value (_ptr, _ptr+length (), t,
                              _ptr, multiplies<double> ());
        return *this;
    }
    ...
    {
        WRITE_LOCK(va_mutex);
        __msipl_copy_value (_ptr, _ptr+length (), t, _ptr, divides<double> ());
        return *this;
    }
    ...
    {
        WRITE_LOCK(va_mutex);
        __msipl_copy_value (_ptr, _ptr+length (), t, _ptr, plus<double> ());
        return *this;
    }
    ...
    {
        WRITE_LOCK(va_mutex);
        __msipl_copy_value (_ptr, _ptr+length (), t, _ptr, minus<double> ());
        return *this;
    }
...
#endif
        __msipl_copy_array (_ptr, _ptr+rlen, v.operator const double* (),
                              _ptr, multiplies<double> ());
        return *this;
    }
...
//
    ...
    //    
    double mult (size_t) const;
    double min () const;
    double max () const;

    valarray shift (int) const;
    valarray cshift (int) const;
    valarray apply (double func (double)) const;
    valarray apply (double func (const double&)) const;
    ...
    void  resize (size_t sz, const double& c = double ());
...
public:
   ...
   : _len (::min (v1.length (), v2.length ())), _ptr (_len ? new double[_len] : 0)
   {
...
public:
   ...
   valarray (size_t len, double* ptr)
   : _len (len), _ptr (ptr) {}

//
// friend declarations for arithmetic & relational operators & global functions
//
   friend valarray operator* (const valarray&, const double&);
   friend valarray operator* (const double&, const valarray&);
   friend valarray operator* (const valarray&, const valarray&);
   ...
   friend valarray<bool> operator== (const valarray&, const double&);
   friend valarray<bool> operator== (const double&, const valarray&);
   friend valarray<bool>
   operator== (const valarray<double>&, const valarray<double>&);
   ...
   friend valarray atan2 (const valarray&, const double&);
   friend valarray atan2 (const double&, const valarray&);
   friend valarray atan2 (const valarray&, const valarray&);

   friend valarray pow (const valarray&, const double&);
   friend valarray pow (const double&, const valarray&);
   friend valarray pow (const valarray&, const valarray&);
   friend double        min (const valarray&);
   friend double        max (const valarray&);
};
...
inline
valarray<double>&
valarray<double>::operator= (const valarray<double>& v)  //bkoz specialize for more than just double?
{
    WRITE_LOCK(va_mutex);
    if (this != &v)
    {
...
inline
valarray<double>&
valarray<double>::operator= (const slice_array<double>& s)
{
    size_t  len = s._len;
    WRITE_LOCK(va_mutex);
    double*      ptr = (len ? ((length () != len) ?  new double[len] : _ptr ) : 0);
...
inline
valarray<double>&
valarray<double>::operator= (const gslice_array<double>& g)
{
    size_t  len = g._len;
    WRITE_LOCK(va_mutex);
    double*      ptr = (len ? ((length () != len) ?  new double[len] : _ptr ) : 0);
...
inline
valarray<double>&
valarray<double>::operator= (const mask_array<double>& m)
{
    size_t  len = m._len;
    WRITE_LOCK(va_mutex);
    double*      ptr = (len ? ((length () != len) ?  new double[len] : _ptr ) : 0);
...
inline
valarray<double>&
valarray<double>::operator= (const indirect_array<double>& i)
{
    size_t  len = i._len;
    WRITE_LOCK(va_mutex);
    double*      ptr = (len ? ((length () != len) ?  new double[len] : _ptr ) : 0);
...
inline
double
valarray<double>::mult (size_t len) const
{
    double  prod = 1;
    READ_LOCK(va_mutex);
#ifdef MSIPL_USING_NAMESPACE
...
inline
valarray<double>
valarray<double>::shift (int i) const
{
    ...
    READ_LOCK(va_mutex);
    size_t len  = length ();
    valarray<double> ret (double (), len);
...
inline
valarray<double>
valarray<double>::cshift (int i) const
{
    READ_LOCK(va_mutex);
    // floatake the absolute value of i in j.
    int j = (i > 0) ? i : -i;
...
inline
valarray<double>
valarray<double>::apply (double func (double)) const
{
    READ_LOCK(va_mutex);
    size_t len  = length ();
    double*     ptr  = len ? new double[len] : 0;
    __msipl_copy_value (_ptr, _ptr+len, ptr, func);
    return valarray<double> (len, ptr);
}

inline
valarray<double>
valarray<double>::apply (double func (const double&)) const
{
    READ_LOCK(va_mutex);
    size_t len  = length ();
    double*     ptr  = len ? new double[len] : 0;
...
inline
void
valarray<double>::resize (size_t sz, const double& c)  //961113 bkoz
{
    WRITE_LOCK(va_mutex);
    valarray<double>  v1(*this);

    if (sz < _len)
    {
        delete_alloc ();
        _ptr = new double[sz+1];
        _len = sz;
#ifdef MSIPL_USING_NAMESPACE
    ...
    else if (sz > _len)
    {
        ...
        _ptr = new double[sz+1];
        _len = sz;
        valarray<double>  v2(c, (sz-v1.length ()));
