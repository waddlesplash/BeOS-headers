 ...
 *
 * GLUT_XLIB_IMPLEMENTATION=4  mjk's GLUT 2.4 images. 6/??/95
 *
 */
#ifndef GLUT_XLIB_IMPLEMENTATION	/* allow this to be overriden */
#define GLUT_XLIB_IMPLEMENTATION	4
#endif

/* display mode bit masks */
#define GLUT_RGB			BGL_RGB
#define GLUT_RGBA			BGL_RGB
#define GLUT_INDEX			BGL_INDEX
#define GLUT_SINGLE			BGL_SINGLE
#define GLUT_DOUBLE			BGL_DOUBLE
#define GLUT_ACCUM			BGL_ACCUM
#define GLUT_ALPHA			BGL_ALPHA
#define GLUT_DEPTH			BGL_DEPTH
#define GLUT_STENCIL		BGL_STENCIL
...
/* Note: Color index modes not supported */
/*
