...
#define 	B_NOW 			((int)(system_time()/1000))

/*------------------------------------------------------------*/

// Useful defines
#define B_HIGH_NIBBLE(x)		((x) & 0xf0)
#define B_LOW_NIBBLE(x)			((x) & 0x0f)
...
const uchar	B_SONG_POS_PTR		= 0xf2;
...
const uchar	B_BREATH_CTRL			= 0x02;
const uchar	_B_RESERVED_OP_T_CTRL	= 0x04;
...
const uchar	B_EXT_EFFECTS_DEPTH		= 0x5b;
