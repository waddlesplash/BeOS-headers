...
typedef struct locked_pool_interface {
	// allocate block	
	...
	// name			- name of pool
	// lock_flags	- flags to be passed to "lock" of create_area()
...
#define LOCKED_POOL_INTERFACE "locked_pool/v1"

#define LOCKED_POOL_MODULE_NAME "generic/locked_pool"
