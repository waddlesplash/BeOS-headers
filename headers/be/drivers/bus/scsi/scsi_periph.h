/* 
	...
	Part of SCSI Peripheral Driver
...
// interface to be provided by peripheral driver
...
typedef struct scsi_periph_interface {
	...
	status_t (*register_device)( 
		...
		const scsi_periph_callbacks *callbacks,
		scsi_device scsi_device, 
		const scsi_device_interface *scsi,
...
#define SCSI_PERIPH_INTERFACE "scsi_periph"
#define SCSI_PERIPH_MODULE_NAME "scsi/generic/scsi_periph/v1"
