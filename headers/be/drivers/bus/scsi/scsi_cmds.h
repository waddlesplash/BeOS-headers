...
#define SCSIS_ASC_NO_MEDIUM_TRAY_CLOSED 0x3a01		// medium not present - tray closed
#define SCSIS_ASC_NO_MEDIUM_TRAY_OPEN 0x3a02		// medium not present - tray open
#define SCSIS_ASC_NO_MEDIUM_LOADABLE 0x3a03		// medium not present - loadable
#define SCSIS_ASC_NO_MEDIUM_AUX_AVAILABLE 0x3a04	// medium not present - medium auxiliary memory available
